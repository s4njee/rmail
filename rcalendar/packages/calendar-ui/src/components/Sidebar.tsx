  ...
  return (
    <aside
      style={{
        ...
        background: 'var(--al-sidebar, #F4F4F4)',
        'border-right': '1px solid var(--al-border, #E0E0E0)',
    ...
    >
      ...
      <div style={{ padding: '18px 18px 14px' }}>
        <div style={{ display: 'flex', 'align-items': 'baseline', 'justify-content': 'space-between', 'margin-bottom': '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', color: 'var(--al-ink-7, #A0A0A0)', 'font-family': 'var(--al-font-mono)', 'font-size': '12px' }}>
            <button
              type="button"
        ...
        {/* Weekday headers */}
        <div style={{ display: 'grid', 'grid-template-columns': 'repeat(7, 1fr)', gap: '1px 0', 'font-family': 'var(--al-font-mono)', 'font-size': '9.5px', color: 'var(--al-ink-7, #A0A0A0)', 'letter-spacing': '0.06em', 'margin-bottom': '4px' }}>
          ...
          <For each={props.calendars}>
            {(cal) => (
              ...
              >
                ...
                />
                <span style={{ 'font-size': '12.5px', color: cal.enabled ? 'var(--al-ink, #1A1A1A)' : 'var(--al-ink-7, #A0A0A0)' }}>
                  {cal.name}
                </span>
                <div style={{ flex: 1 }} />
      ...
      <div style={{ padding: '16px 18px', flex: 1, 'min-height': 0, 'overflow-y': 'auto' }}>
        <div style={{ display: 'flex', 'align-items': 'center', 'justify-content': 'space-between', 'margin-bottom': '10px' }}>
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', 'font-family': 'var(--al-font-mono)', 'font-size': '11px', color: 'var(--al-ink-7, #A0A0A0)', padding: '0 2px' }}
          >
            +
          </button>
        </div>
              ...
              return (
                <div style={{ display: 'flex', 'align-items': 'flex-start', gap: '9px' }}>
                  ...
                  <div style={{ display: 'flex', 'flex-direction': 'column', gap: '2px', 'min-width': 0 }}>
                    ...
                    <span style={{ 'font-family': 'var(--al-font-mono)', 'font-size': '10px', color: metaColor() }}>
                      {dueText()}
                    </span>
                  </div>
                </div>
      ...
      {/* 4. Sync Footer */}
      <div style={{ padding: '13px 18px', 'border-top': '1px solid var(--al-border, #E0E0E0)', display: 'flex', 'align-items': 'center', gap: '9px' }}>
        <div style={{ width: '7px', height: '7px', 'border-radius': '50%', background: 'var(--al-cal-work, #0F766E)', flex: 'none' }} />
        ...
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px', display: 'flex', 'flex-direction': 'column', gap: '2.5px', 'align-items': 'center' }}
        >
          <div style={{ width: '3px', height: '3px', 'border-radius': '50%', background: 'var(--al-ink-7, #A0A0A0)' }} />
          <div style={{ width: '3px', height: '3px', 'border-radius': '50%', background: 'var(--al-ink-7, #A0A0A0)' }} />
          <div style={{ width: '3px', height: '3px', 'border-radius': '50%', background: 'var(--al-ink-7, #A0A0A0)' }} />
        </button>
      </div>
