    ...
    <Show when={props.isOpen}>
      ...
      >
        ...
        <form
          ...
          style={{ padding: "20px 26px", display: "flex", "flex-direction": "column", gap: "16px" }}
        >
          <div
            style={{ "font-size": "13px", color: "var(--al-ink-5, #777777)", "line-height": 1.5 }}
          >
            Synchronize events bidirectionally with Google Calendar. Events will stay available
            offline in your local SQLite store.
          </div>
