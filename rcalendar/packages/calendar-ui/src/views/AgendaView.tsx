    ...
    >
        ...
        >
          <button
            ...
            style={{
              ...
              color:
                filterMode() === "events" ? "var(--al-ink, #1A1A1A)" : "var(--al-ink-5, #777777)",
              "box-shadow":
                filterMode() === "events"
                  ? "var(--al-shadow-segment-active, 0 1px 2px rgba(0,0,0,0.10))"
                  : "none",
            }}
          >
            Events
      ...
      <div style={{ flex: 1, "overflow-y": "auto", padding: "0 34px" }}>
        ...
        >
          {(group) => {
            const numFg = () =>
              group.isToday ? "var(--al-accent, #1F6FEB)" : "var(--al-ink, #1A1A1A)";
                ...
                >
                  <For each={group.items}>
                    {(item, idx) => {
                      ...
                      const rowBg = () =>
                        isZebra() ? "var(--al-surface-2, #FBFBFB)" : "transparent";
                        ...
                        >
                            ...
                            fallback={
                              <button
                                ...
                                style={{
                                  ...
                                  background: item.rawTask?.completedAt
                                    ? "var(--al-ink-9, #BFBFBF)"
                                    : "transparent",
                                  flex: "none",
                                  cursor: "pointer",
                          ...
                          <span
                            style={{
                              ...
                              "text-decoration": item.rawTask?.completedAt
                                ? "line-through"
                                : "none",
                            }}
                          >
