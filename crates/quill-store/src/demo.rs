...
pub(crate) fn demo_accounts() -> Vec<Account> {
    vec![
        Account {
            ...
            smtp_server: "smtp.quill.app".into(),
            smtp_port: 587,
            smtp_security: "starttls".into(),
            smtp_username: "work@quill.app".into(),
        ...
        Account {
            ...
            imap_security: "ssl".into(),
            allow_plaintext_login: false,
            smtp_server: "smtp.fastmail.com".into(),
            smtp_port: 465,
            smtp_security: "ssl".into(),
            smtp_username: "rosa.personal@fastmail.com".into(),
            folder_count: 0,
            last_error: None,
        },
        Account {
            ...
            smtp_port: 1025,
            smtp_security: "plain".into(),
            smtp_username: "meridian.board@proton.me".into(),
            folder_count: 0,
